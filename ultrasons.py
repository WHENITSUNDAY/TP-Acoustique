...
aluminium_shape = 2 # 1 pour une plaque rectangulaire, 2 pour un cercle, 3 pour hexagone, 4 pour triangle équilatéral
...
if aluminium_shape == 1:
    ...
    alu_distance = Lx/2 - alu_thickness/2 # Distance entre l'émetteur et la plaque d'aluminium (m)
